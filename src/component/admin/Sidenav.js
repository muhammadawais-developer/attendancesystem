      ...
      <ul className="space-y-2 font-medium mt-5">
        ...
        <li>
          ...
          >
            ...
            {/* <Link to="showshift" className='font-semibold' > */}
              Shift
            {/* </Link> */}
            </span>
          </Link>
        ...
        <li>
          ...
          >
            ...
            <span className="flex-1 ml-3 whitespace-nowrap font-semibold">Department</span>
          </Link>
        </li>
        <li>
          <Link
          ...
          >
            ...
            <span className="flex-1 ml-3 whitespace-nowrap font-semibold ">Register</span>
          </Link>
        </li>
        {/* <li>
          <a
